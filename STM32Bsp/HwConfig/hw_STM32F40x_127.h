...
#define HARDWARE_VER            "STF407VG-V1.2.7"
...
#define STARBOT_LED_STATUS_PORT				GPIOC
#define STARBOT_LED_STATUS_CLK				RCC_AHB1Periph_GPIOC
#define STARBOT_LED_STATUS_PIN				GPIO_Pin_14
...
#define STARBOT_LED_RUN_PORT				GPIOA
#define STARBOT_LED_RUN_CLK					RCC_AHB1Periph_GPIOA
#define STARBOT_LED_RUN_PIN					GPIO_Pin_8
#define STARBOT_LED_RUN_On()             	GPIO_SetBits(STARBOT_LED_RUN_PORT,STARBOT_LED_RUN_PIN)     
#define STARBOT_LED_RUN_Off()            	GPIO_ResetBits(STARBOT_LED_RUN_PORT,STARBOT_LED_RUN_PIN) 
#define STARBOT_LED_RUN_Toggle()         	GPIO_ToggleBits(STARBOT_LED_RUN_PORT,STARBOT_LED_RUN_PIN)

#define STARBOT_LED_FAULT_PORT				GPIOC
#define STARBOT_LED_FAULT_CLK				RCC_AHB1Periph_GPIOC
#define STARBOT_LED_FAULT_PIN				GPIO_Pin_15
...
#define STARBOT_IMU_N_SCL_PORT				GPIOD
#define STARBOT_IMU_N_SDA_PORT				GPIOD
#define STARBOT_IMU_N_SCL_CLK    			RCC_AHB1Periph_GPIOD
#define STARBOT_IMU_N_SDA_CLK    			RCC_AHB1Periph_GPIOD
         

#define STARBOT_IMU_W_SCL_PIN				GPIO_Pin_4
#define STARBOT_IMU_W_SDA_PIN				GPIO_Pin_5
#define STARBOT_IMU_W_SCL_PORT				GPIOB
#define STARBOT_IMU_W_SDA_PORT				GPIOB
#define STARBOT_IMU_W_SCL_CLK    			RCC_AHB1Periph_GPIOB
#define STARBOT_IMU_W_SDA_CLK    			RCC_AHB1Periph_GPIOB


#define STARBOT_OLED_SCL_PIN				GPIO_Pin_6
#define STARBOT_OLED_SDA_PIN				GPIO_Pin_7
#define STARBOT_OLED_SCL_PORT				GPIOB
#define STARBOT_OLED_SDA_PORT				GPIOB
#define STARBOT_OLED_SCL_CLK    			RCC_AHB1Periph_GPIOB
#define STARBOT_OLED_SDA_CLK    			RCC_AHB1Periph_GPIOB
...
/** -----------Motor Config ---------**/ 
#define MOTORn						        4
#define STARBOT_MOTOR1_A_PIN		 		GPIO_Pin_11
#define STARBOT_MOTOR1_A_PINSOU		 		GPIO_PinSource11
#define STARBOT_MOTOR1_A_GPIO_PORT	 		GPIOE
#define STARBOT_MOTOR1_A_GPIO_CLK	 		RCC_AHB1Periph_GPIOE
#define STARBOT_MOTOR1_B_PIN   	 	   	 	GPIO_Pin_13
#define STARBOT_MOTOR1_B_PINSOU		 		GPIO_PinSource13
...
#define STARBOT_MOTOR1_A_CHANNEL			TIM_Channel_2
#define STARBOT_MOTOR1_B_CHANNEL			TIM_Channel_3
#define STARBOT_MOTOR1_AF_TIM               GPIO_AF_TIM1

#define STARBOT_MOTOR2_A_PIN		 		GPIO_Pin_9
#define STARBOT_MOTOR2_A_PINSOU		 		GPIO_PinSource9
#define STARBOT_MOTOR2_A_GPIO_PORT	 		GPIOE
#define STARBOT_MOTOR2_A_GPIO_CLK	 		RCC_AHB1Periph_GPIOE
#define STARBOT_MOTOR2_B_PIN   	 	   	 	GPIO_Pin_14
#define STARBOT_MOTOR2_B_PINSOU		 		GPIO_PinSource14
...
#define STARBOT_MOTOR2_A_CHANNEL			TIM_Channel_1
#define STARBOT_MOTOR2_B_CHANNEL			TIM_Channel_4
#define STARBOT_MOTOR2_AF_TIM               GPIO_AF_TIM1

#define STARBOT_MOTOR3_A_PIN		 		GPIO_Pin_7
#define STARBOT_MOTOR3_A_PINSOU		 		GPIO_PinSource7
#define STARBOT_MOTOR3_A_GPIO_PORT	 		GPIOC
#define STARBOT_MOTOR3_A_GPIO_CLK	 		RCC_AHB1Periph_GPIOC
#define STARBOT_MOTOR3_B_PIN   	 	   	 	GPIO_Pin_6
#define STARBOT_MOTOR3_B_PINSOU		 		GPIO_PinSource6
...
#define STARBOT_MOTOR3_A_CHANNEL			TIM_Channel_2
#define STARBOT_MOTOR3_B_CHANNEL			TIM_Channel_1
#define STARBOT_MOTOR3_AF_TIM               GPIO_AF_TIM8

//PA8 TIM_CH1 TIM_CH1N
#define STARBOT_MOTOR4_A_PIN		 		GPIO_Pin_8
#define STARBOT_MOTOR4_A_PINSOU		 		GPIO_PinSource8
#define STARBOT_MOTOR4_A_GPIO_PORT	 		GPIOC
#define STARBOT_MOTOR4_A_GPIO_CLK	 		RCC_AHB1Periph_GPIOC
#define STARBOT_MOTOR4_B_PIN   	 	   	 	GPIO_Pin_9
#define STARBOT_MOTOR4_B_PINSOU		 		GPIO_PinSource9
...
#define STARBOT_MOTOR4_A_CHANNEL			TIM_Channel_3
#define STARBOT_MOTOR4_B_CHANNEL			TIM_Channel_4
...
#define STARBOT_ENCODER2_A_PIN           	GPIO_Pin_15
#define STARBOT_ENCODER2_A_GPIO_PORT      	GPIOA
#define STARBOT_ENCODER2_A_GPIO_PinSource 	GPIO_PinSource15
...
#define STARBOT_ADC2_PIN					GPIO_Pin_6
#define STARBOT_ADC2_GPIO_PORT				GPIOA
#define STARBOT_ADC2_GPIO_CLK				RCC_AHB1Periph_GPIOA
#define STARBOT_ADC2_CHANNEL         		ADC_Channel_6
...
#define STARBOT_SONAR1_TIM_ARR				0XFFFF//0XFFFF
...
#define WS2812n 							2
#define STARBOT_WS2812_1_GPIO_PORT	 		GPIOD
#define STARBOT_WS2812_1_TIM            	TIM4
#define STARBOT_WS2812_1_DMA_Stream 		DMA1_Stream0
#define STARBOT_WS2812_1_PIN		 		GPIO_Pin_12
#define STARBOT_WS2812_1_PINSOU		 		GPIO_PinSource12
#define STARBOT_WS2812_1_GPIO_CLK			RCC_AHB1Periph_GPIOD
#define STARBOT_WS2812_1_TIM_CLK        	RCC_APB1Periph_TIM4
#define STARBOT_WS2812_1_AF_TIM         	GPIO_AF_TIM4
#define STARBOT_WS2812_1_DMA_CLK        	RCC_AHB1Periph_DMA1
#define STARBOT_WS2812_1_DMA_CHANNEL		DMA_Channel_2
#define STARBOT_WS2812_1_TIM_DMA_CC 		TIM_DMA_CC1
#define STARBOT_WS2812_1_DMA_TCIF			DMA_FLAG_TCIF0

#define STARBOT_WS2812_2_GPIO_PORT	 		GPIOD
#define STARBOT_WS2812_2_TIM            	TIM4
#define STARBOT_WS2812_2_DMA_Stream 		DMA1_Stream3
#define STARBOT_WS2812_2_PIN		 		GPIO_Pin_13
#define STARBOT_WS2812_2_PINSOU		 		GPIO_PinSource13
...
#define STARBOT_WS2812_2_TIM_DMA_CC 		TIM_DMA_CC2
#define STARBOT_WS2812_2_DMA_TCIF			DMA_FLAG_TCIF3

#define STARBOT_CAN							CAN1
#define STARBOT_CAN_AF						GPIO_AF_CAN1
#define STARBOT_CAN_CLK						RCC_APB1Periph_CAN1
#define STARBOT_CAN_IRQ	 					CAN1_RX0_IRQn
#define STARBOT_CAN_RX_IRQHandler			CAN1_RX0_IRQHandler
#define STARBOT_CAN_FilterNumber			0
#define STARBOT_CAN_TX_CLK					RCC_AHB1Periph_GPIOD
#define STARBOT_CAN_TX_GPIO_PORT			GPIOD
#define STARBOT_CAN_TX_GPIO					GPIO_Pin_0
#define STARBOT_CAN_TX_PINSOURCE			GPIO_PinSource0
#define STARBOT_CAN_RX_CLK					RCC_AHB1Periph_GPIOD
#define STARBOT_CAN_RX_GPIO_PORT			GPIOD
#define STARBOT_CAN_RX_GPIO					GPIO_Pin_1
#define STARBOT_CAN_RX_PINSOURCE			GPIO_PinSource1
