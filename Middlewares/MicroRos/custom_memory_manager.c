...
#define configMicroROsTOTAL_HEAP_SIZE 20480  //20*1024
/* Allocate the memory for the heap. */
//static uint8_t ucHeap[ configTOTAL_HEAP_SIZE ];
static uint8_t ucHeap[configMicroROsTOTAL_HEAP_SIZE];
...
size_t uxAddress;
size_t xTotalHeapSize = configMicroROsTOTAL_HEAP_SIZE;
